  ...
  <div class="container mt-4">
    ...
    <form @submit.prevent="handleFormSubmit">
      ...
      <section class="mb-4">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <label for="PhysicalHealth" class="form-label">For how many days during the past 30 days was your physical health (which includes physical illness and injury) <strong>not</strong> good?</label>
            <input type="range" id="PhysicalHealth" class="form-range" v-model="formData.PhysicalHealth" :min="0" :max="30" />
            <small class="form-text">Selected Days: {{ formData.PhysicalHealth }}</small>
          </div>
          <div class="col-md-6 mb-3">
            <label for="MentalHealth" class="form-label">For how many days during the past 30 days was your mental health (which includes stress, depression, and problems with emotions) <strong>not</strong> good?</label>
            <input type="range" id="MentalHealth" class="form-range" v-model="formData.MentalHealth" :min="0" :max="30" />
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <select id="Diabetic" class="form-control" v-model="formData.Diabetic">
              <option value="">Select</option>
              <option v-for="option in formData.Sex === 'Female' ? [...DiabeticOptionsConsistent, PregnancyOption] : DiabeticOptionsConsistent"
